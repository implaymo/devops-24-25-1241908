...
2. [Steps to Follow](#steps-to-follow)
    ...
    2. [Initialize a Gradle Project](#initialize-a-gradle-project)
    3. [Extract and Set Up the Project](#extract-and-set-up-the-project)
    4. [Replace Source Code](#replace-source-code)
    5. [Run the Application](#run-the-application)
    6. [Add Frontend Support](#add-frontend-support)
    7. [Configure Webpack Execution in PackageJSON](#configure-webpack-execution-in-packagejson)
    8. [Build and Run Application](#build-and-run-application)
    9. [Automate JAR Deployment](#automate-jar-deployment)
    10. [Clean Generated Frontend Files](#clean-generated-frontend-files)
    11. [Testing and Finalization](#testing-and-finalization)
    12. [Tagging the Repository](#tagging-the-repository)
